...
// under the License.
//
// NOTE ON LICENSING: this file is NOT part of go-ethereum and is not a
// derivative work of it. It is JavaScript executed BY geth's console via
// `geth attach --preload`; it links against no geth code and contains none.
// It therefore carries its own copyright and licence, independent of the
// LGPL/GPL that covers the client itself.
